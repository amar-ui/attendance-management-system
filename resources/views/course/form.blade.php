...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card ">
            ...
            <form method="post"
                action="@isset($edit){{ route('course.update', ['course'=>$edit->id]) }} @else {{ route('course.store') }} @endif"
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="txet" class="form-control" name="name" id="name" required
                                    placeholder="Course" @isset($edit) value="{{ $edit->name }}" @endif>
                            </div>
                        </div>
                    </div> --}}
                            ...
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    ...
                                    <button rel="tooltip" class="btn btn-danger btn-link" data-original-title=""
                                        ...
                                        data-href="{{ route('course.destroy', ['course'=>$row->id]) }}">
